...
const XingIcon = ({ height = 24 }) => (
  ...
  >
    <g fillRule="evenodd" clipRule="evenodd">
      <path
        fill="#0698A0"
        d="m1.805 5.084 3.635 6.479L0 22.018h6.491l5.4-9.555-3.634-6.48z"
      />
      <path
        fill="#B7DF4D"
        d="m21.122 0-10.49 18.642 17.396 31h6.581L27.606 0z"
      />
      <path
        fill="#0698A0"
        d="m40.505 2.998 3.777 7.979 4.129-7.979h5.387l-6.608 11.98 6.868 13.024h-5.647l-4.245-8.734-4.207 8.734h-5.426l6.543-12.958-6.258-12.046zm16.578 25.004h5.245V2.998h-5.245zm9.8 0h5.245V2.998h-5.245zm13.5 0h5.474V13.869h.245c.66.6 1.26 1.25 1.88 1.87 2.58 2.62 5.55 5.62 8.3 8.3h4.96V2.998h-5.62v12.75l-10.81-12.775H80.383zm25.44 0c4.91 0 8.79-1.7 11.61-5.06l-3.99-2.07c-1.08 1.43-3.06 2.42-5.71 2.42-4.34 0-7.69-3.3-7.69-8.11 0-4.86 3.11-8.11 7.69-8.11 2.88 0 5.19.99 6.75 3.26l3.27-2.77c3.10 3.15 12.77 10.81 12.775 2.44 0 4.907-.509 7.413-1.695 13.649z"
      />
    </g>
  </svg>
);
...
const translations = {
  ...
  de: {
    ...
    engineeringCycle: "UPSTRUX verfügt über die Fähigkeit, komplexe Ingenieur- und Investitionsprojekte zu koordinieren und zu steuern, die eine enge Zusammenarbeit zwischen unterschiedlichen technischen Fachbereichen, spezialisierten Expertenteams sowie allen Beteiligten des Investitions- und Bauprozesses erfordern. Unser Ansatz geht über die Entwicklung einzelner Planungslösungen hinaus und basiert auf der effektiven Integration von Architekten, Tragwerksplanern, Geotechnikingenieuren, Wasserbauingenieuren, Verkehrsingenieuren, Vermessungsingenieuren und technischen Beratern innerhalb einer einheitlichen Projektumgebung. Durch einen integrierten Ansatz und die Koordination sämtlicher Projektphasen — von der Konzeptentwicklung bis zur Projektrealisierung — bietet UPSTRUX nachhaltige Ingenieurlösungen sowie die Optimierung des Projektumfangs, der finanziellen, technischen und personellen Ressourcen, der Terminparameter, des Qualitätsmanagements und des Projektrisikomanagements.",
