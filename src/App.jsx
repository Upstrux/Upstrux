...
const translations = {
  bg: {
    ...
    projectsPage: {
      eyebrow: "Комплексни проекти в областта на инфраструктурата, индустрията, енергетиката, сградното строителство и съоръженията",
      eyebrow2: "Комплексни проекти в областта на инфраструктурата, индустрията, енергетиката, сградното строителство и съоръженията",
      title: "Проекти",
