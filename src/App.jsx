...
<section id="about" className="bg-white px-6 py-28"><div className="mx-auto max-w-7xl"><p className="text-sm font-bold uppercase tracking-[0.22em] text-blue-700">{t.aboutLabel}</p><h2 className="mt-3 text-3xl font-light leading-[1.06] tracking-[-0.028em] text-[#111111] md:text-4xl">{t.aboutTitle}</h2><div className="mt-8 grid gap-10 lg:grid-cols-2"><p className="text-lg leading-8 text-slate-700">{t.aboutP1}</p><p className="text-lg leading-8 text-slate-700">{t.aboutP2}</p></div><div className="mt-7 border-l-4 border-blue-600 bg-white px-8 py-5"><p className="text-xl font-light leading-7 tracking-[-0.02em] text-[#111111]">{t.aboutHighlight}</p></div></div></section>
