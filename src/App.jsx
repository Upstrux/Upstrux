...
function Logo({ footer = false }) {
  ...
  return (
    <div className="flex flex-col items-center text-center">
      <div className={`inline-flex items-end justify-center text-4xl font-light leading-none tracking-[0.34em] md:text-4xl ${textColor}`}>
...
const SOCIAL_LINKS = {
  ...
  facebook: "https://www.facebook.com/profile.php?id=61590765290915",
...
const PAGE_ROUTES_BY_LANGUAGE = {
  en: {
    ...
    legal: "/legal",
    privacy: "/privacy",
    service1: "/services/structural-assessments-diagnostics-in-situ-and-laboratory-testing",
    service2: "/services/architecture-and-structural-engineering",
    service3: "/services/wss-hydrotechnical-and-hydro-reclamation-engineering",
    service4: "/services/geotechnical-engineering-design",
    service5: "/services/transport-infrastructure-engineering-and-design",
    service6: "/services/geodesy-cadastre-gis-and-photogrammetry",
    service7: "/services/project-management-and-coordination",
    service8: "/services/pre-investment-studies-and-tender-planning",
  },
  bg: {
    home: "/",
    about: "/za-nas",
    ...
    service1: "/uslugi/obsledvaniya-in-situ-i-laboratorni-izpitvaniya",
    service2: "/uslugi/arhitektura-i-proektirane-na-sgradi",
    service3: "/uslugi/vik-hidrotehnichesko-i-hidromeliorativno-proektirane",
    service4: "/uslugi/geotehnichesko-proektirane",
    service5: "/uslugi/proektirane-na-transportnata-infrastruktura",
    service6: "/uslugi/geodeziya-kadastar-gis-i-fotogrametriya",
    service7: "/uslugi/upravlenie-i-koordinatsiya-na-proekti",
    service8: "/uslugi/predinvestitsionni-prouchvaniya-i-ofertno-planirane",
  },
  de: {
    home: "/",
    about: "/uber-uns",
    ...
    legal: "/rechtliches",
    privacy: "/datenschutz",
    service1: "/leistungen/bauwerksuntersuchungen-diagnostik-sowie-in-situ-und-laborprufungen",
    service2: "/leistungen/architektur-und-tragwerksplanung",
    service3: "/leistungen/wasserversorgungs-siedlungswasserwirtschafts-wasserbau-und-hydro-meliorationsplanung",
    service4: "/leistungen/geotechnische-planung",
    service5: "/leistungen/planung-von-verkehrsinfrastruktur",
    service6: "/leistungen/geodasie-kataster-gis-und-photogrammetrie",
    service7: "/leistungen/projektmanagement-und-projektkoordination",
    service8: "/leistungen/vorinvestitionsstudien-und-ausschreibungsplanung",
  },
};
...
const ROUTE_PAGES = {
  ...
  "/our-approach": { page: "about", sectionId: "methodology" },
  ...
  "/nashiyt-podhod": { page: "about", sectionId: "methodology" },
...
const teamMembersByLanguage = {
  ...
  en: [
    ["Assoc. Prof. Dr. Arch. Gichka Kutova-Kamenova","Chairperson of the Management Board","The first woman Rector and the first architect Rector of UACEG, elected in 2023, with extensive academic and management experience. She graduated from UACEG and defended her doctoral dissertation in 2009, and in 2012 she habilitated as an Associate Professor. She has held the positions of Head of Department, Vice-Dean and Vice-Rector for Research and Applied Activities. Her research interests are in the fields of energy efficiency, renewable energy sources and solar architecture. She is the author of more than 20 scientific publications and has participated in a number of research projects and international forums. Under her leadership, UACEG has expanded its partnerships with business and international institutions.",member01],
    ["Prof. Dr. Eng. Elena Peneva-Zlatkova","Deputy Chairperson and Member of the Management Board","Professor of general, higher and applied geodesy at the Department of Higher Geodesy of the Faculty of Geodesy at UACEG. Since 2024 she has served as Vice-Rector for Research and Applied Activities, leading the Centre for Research and Design and a number of university scientific and expert structures. She has been Dean and Head of the Department of Higher Geodesy, as well as Vice-Dean of the Faculty. She is the author of more than 50 scientific publications and has participated in more than 20 projects. She has long-standing experience in academic management, research activity and the development of higher engineering education.",member02],
    ["Assoc. Prof. Dr. Eng. Emad Abdulahad","Member of the Management Board","Structural civil engineer, Dean of the Faculty of Structural Engineering at UACEG and Associate Professor in the Department of Reinforced Concrete Structures in the discipline Assessment and Testing of Building Structures and Facilities. His research and teaching activities focus on the assessment and testing of building structures, seismic evaluation and strengthening of buildings, analysis of defects and failures, as well as the development of strengthening technologies using composite materials. He leads projects and specialized training related to the sustainability, safety and rehabilitation of the existing building stock.",member03],
    ["Prof. Dr. Arch. Orlin Davchev","Member of the Management Board","Academic leader and lecturer in the Department of Interior and Design for Architecture at UACEG and former Dean of the Faculty of Architecture. He has long-standing experience in architectural and interior design, with numerous completed projects and academic initiatives. Under his leadership, the Faculty of Architecture has established itself as a modern educational and scientific institution with more than 70 years of history, focused on innovation, contemporary pedagogical approaches and the sustainable development of architectural education.",member04],
    ["Assoc. Prof. Dr. Eng. Ivan Kunchev","Member of the Management Board","Dean of the Faculty of Geodesy at UACEG since 2024 and Associate Professor in the Department of Geodesy and Geoinformatics. He works actively for the development of the Faculty as a leading academic centre in the fields of geodesy, cadastre, cartography and geoinformation technologies. His scientific and professional activity is focused on spatial information systems, geodetic technologies and the integration of building information models. He leads research projects and international partnerships, and since 2005 has held full design qualification rights in the field of geodesy and applied engineering activities.",member05],
    ["Assoc. Prof. Dr. Eng. Geol. Ivaylo Ivanov","Member of the Management Board","Dean of the Faculty of Transportation Engineering at UACEG and lecturer with more than 20 years of experience in the fields of engineering geology and hydrogeology. His professional activity is focused on the development of transport infrastructure, contemporary engineering technologies and the practical application of geological investigations in construction. He works actively to introduce innovative methods and modern educational approaches in the training of highly qualified specialists for the needs of the construction and infrastructure sector.",member06],
    ["Assoc. Prof. Dr. Eng. Petar Filkov","Member of the Management Board","Dean of the Faculty of Hydrotechnics at UACEG and Associate Professor in the field of water supply, sewerage systems and hydraulic engineering. He works actively to modernize engineering education and develop international academic cooperation. Under his leadership, the Engineering Ecology programme with double-degree graduation has been introduced jointly with the University of Federico II in Naples. He organizes scientific and professional forums with international participation and maintains an active partnership with the Bulgarian Construction Chamber for the practical training of students and the connection between education and engineering practice.",member07]
  ].map(([name,role,bio,image])=>({name,role,bio,image})),

  de: [
    ["Assoc. Prof. Dr. Arch. Gichka Kutova-Kamenova","Vorsitzende des Verwaltungsrats","Die erste Rektorin und zugleich die erste Architektin als Rektorin der UACEG, gewählt im Jahr 2023, mit langjähriger akademischer und Führungserfahrung. Sie absolvierte die UACEG und verteidigte 2009 ihre Doktorarbeit; 2012 habilitierte sie sich als Associate Professor. Sie war als Leiterin eines Lehrstuhls, Prodekanin und Prorektorin für wissenschaftliche und angewandte Tätigkeit tätig. Ihre wissenschaftlichen Interessen liegen in den Bereichen Energieeffizienz, erneuerbare Energiequellen und solare Architektur. Sie ist Autorin von mehr als 20 wissenschaftlichen Publikationen und Teilnehmerin an zahlreichen Forschungsprojekten und internationalen Foren. Unter ihrer Leitung erweitert die UACEG ihre Partnerschaften mit Wirtschaft und internationalen Institutionen.",member01],
    ["Prof. Dr.-Ing. Elena Peneva-Zlatkova","Stellvertretende Vorsitzende und Mitglied des Verwaltungsrats","Professorin für allgemeine, höhere und angewandte Geodäsie am Lehrstuhl für Höhere Geodäsie der Fakultät für Geodäsie an der UACEG. Seit 2024 ist sie Prorektorin für wissenschaftliche und angewandte Tätigkeit und leitet das Zentrum für Forschung und Planung sowie mehrere universitäre wissenschaftliche und fachliche Strukturen. Sie war Dekanin und Leiterin des Lehrstuhls für Höhere Geodäsie sowie Prodekanin der Fakultät. Sie ist Autorin von mehr als 50 wissenschaftlichen Publikationen und hat an mehr als 20 Projekten mitgewirkt. Sie verfügt über langjährige Erfahrung im akademischen Management, in der Forschungstätigkeit und in der Entwicklung der höheren Ingenieurausbildung.",member02],
    ["Assoc. Prof. Dr.-Ing. Emad Abdulahad","Mitglied des Verwaltungsrats","Bauingenieur für Tragwerksplanung, Dekan der Fakultät für Bauingenieurwesen an der UACEG und Associate Professor am Lehrstuhl für Massive Konstruktionen im Fachgebiet Untersuchung und Prüfung von Baukonstruktionen und Anlagen. Seine wissenschaftliche und lehrende Tätigkeit konzentriert sich auf Untersuchung und Prüfung von Baukonstruktionen, seismische Bewertung und Verstärkung von Gebäuden, Analyse von Mängeln und Havarien sowie die Entwicklung von Verstärkungstechnologien mit Verbundwerkstoffen. Er leitet Projekte und spezialisierte Schulungen im Zusammenhang mit Nachhaltigkeit, Sicherheit und Wiederherstellung des bestehenden Gebäudebestands.",member03],
    ["Prof. Dr. Arch. Orlin Davchev","Mitglied des Verwaltungsrats","Akademischer Leiter und Dozent am Lehrstuhl für Interieur und Design für Architektur an der UACEG sowie ehemaliger Dekan der Fakultät für Architektur. Er verfügt über langjährige Erfahrung im Bereich Architektur- und Innenraumdesign mit zahlreichen realisierten Projekten und akademischen Initiativen. Unter seiner Leitung hat sich die Fakultät für Architektur als moderne Bildungs- und Wissenschaftseinrichtung mit mehr als 70-jähriger Geschichte etabliert, ausgerichtet auf Innovationen, zeitgemäße pädagogische Ansätze und die nachhaltige Entwicklung der Architekturausbildung.",member04],
    ["Assoc. Prof. Dr.-Ing. Ivan Kunchev","Mitglied des Verwaltungsrats","Dekan der Fakultät für Geodäsie an der UACEG seit 2024 und Associate Professor am Lehrstuhl für Geodäsie und Geoinformatik. Er arbeitet aktiv an der Entwicklung der Fakultät als führendes akademisches Zentrum in den Bereichen Geodäsie, Kataster, Kartographie und Geoinformationstechnologien. Seine wissenschaftliche und berufliche Tätigkeit konzentriert sich auf räumliche Informationssysteme, geodätische Technologien und die Integration von Building-Information-Modellen. Er leitet Forschungsprojekte und internationale Partnerschaften und besitzt seit 2005 die volle Planungsberechtigung im Bereich Geodäsie und angewandte Ingenieurtätigkeiten.",member05],
    ["Assoc. Prof. Dr.-Ing. Geol. Ivaylo Ivanov","Mitglied des Verwaltungsrats","Dekan der Fakultät für Verkehrsbau an der UACEG und Dozent mit mehr als 20 Jahren Erfahrung in den Bereichen Ingenieurgeologie und Hydrogeologie. Seine berufliche Tätigkeit ist auf die Entwicklung der Verkehrsinfrastruktur, moderne Ingenieurtechnologien und die praktische Anwendung geologischer Untersuchungen im Bauwesen ausgerichtet. Er arbeitet aktiv an der Einführung innovativer Methoden und moderner Bildungsansätze bei der Ausbildung hochqualifizierter Fachkräfte für die Anforderungen des Bau- und Infrastruktursektors.",member06],
    ["Assoc. Prof. Dr.-Ing. Petar Filkov","Mitglied des Verwaltungsrats","Dekan der Fakultät für Hydrotechnik an der UACEG und Associate Professor im Bereich Wasserversorgung, Kanalisationssysteme und Wasserbau. Er arbeitet aktiv an der Modernisierung der Ingenieurausbildung und an der Entwicklung der internationalen akademischen Zusammenarbeit. Unter seiner Leitung wurde die Studienrichtung Ingenieurökologie mit Doppelabschluss gemeinsam mit der Universität Federico II in Neapel eingeführt. Er organisiert wissenschaftliche und fachliche Foren mit internationaler Beteiligung und pflegt eine aktive Partnerschaft mit der Bulgarischen Baukammer für die praktische Ausbildung der Studierenden und die Verbindung zwischen Bildung und Ingenieurpraxis.",member07]
  ].map(([name,role,bio,image])=>({name,role,bio,image})),
};
...
services: [ "Натурни Обследвания на Строителни Конструкции и Съоражения.", 
  ...
  services: [
    ...
    "Функционално Пространствено Планиране и Интериорна Архитектура.",
    "Многоетапно Проектиране (Прединвестиционни проучвания, Концептуален, Идеен, Технически и Работен проект).",
  ...
  intro: "Ефективността на водната инфраструктура зависи от надеждното хидравлично проектиране, експлоатационната надеждност и дългосрочната устойчивост на активите. Подпомагаме нашите клиенти чрез инженерни анализи, оценки и проектни решения, насочени към оптимизиране на капацитета, намаляване на риска и подобряване на експлоатационните показатели.",
  services: [
  ...
  intro: "Геотехническите условия често са сред основните източници на техническа несигурност и финансов риск в строителството. Чрез геотехнически проучвания, анализи и инженерни решения подпомагаме управлението на риска, оптимизирането на фундаментните системи и осигуряването на дългосрочната устойчивост на сгради и инфраструктурни обекти.",
  services: [
  ...
  intro: "Транспортната инфраструктура е от ключово значение за икономическото развитие и безопасното придвижване на хора и товари. Предоставяме решения за планиране, проектиране, рехабилитация и модернизация на пътища, мостове, тунели, железопътна и градска транспортна инфраструктура с фокус върху безопасността, надеждността и устойчивостта.",
  services: [
  ...
  intro: "Надеждните инженерни решения се основават на точна пространствена информация. Чрез геодезически измервания, геопространствени анализи и цифрово моделиране осигуряваме надеждна база за планиране, проектиране, строителство и управление на активи.",
  services: [
  ...
  intro: "Сложните инженерни проекти изискват ефективна координация, проектен контрол и прозрачни механизми за вземане на решения. Подпомагаме клиентите при управлението на срокове, бюджет, качество и риск, осигурявайки успешна реализация на проектите от идеята до въвеждането им в експлоатация.",
  services: [
  "Определяне на Обхвата на Проекта и Предварителна Оценка на Осъществимостта.",
  "Идентифициране на Проектните Рискове и Първоначална Оценка на Риска.",
  "Идентифициране и Анализ на Заинтересованите Страни.",
  "Разработване на План за Управление на Проекта (PMP) и План за Изпълнение на Проекта (PEP).",
  "Разработване на Структура на Разпределение на Работата (WBS), График на Проекта и Анализ на Критичния Път.",
  "Остойностяване, Разработване на Бюджет и Планиране на Разходите.",
  "Разработване на Планове за Управление на Риска, Качеството, Комуникацията и Отчетността.",
  "Координация на Проекта и Управление на Мултидисциплинарното Проектиране.",
  "Преглед на Проектните Решения и Техническа Координация.",
  "Осигуряване и Контрол на Качеството (QA/QC).",
  "Координация със Заинтересованите Страни и Компетентните Органи.",
  "Контрол на Проекта (График, Разходи, Промени, Документация, Ключови Показатели за Ефективност (KPI) и Управление на Придобитата Стойност (EVM)).",
  "Мониторинг на Напредъка и Отчитане на Изпълнението.",
  "Мониторинг и Контрол на Проектните Рискове.",
  "Одити по Качеството и Мониторинг на Съответствието.",
  "Изпитвания, Въвеждане в Експлоатация и Предаване на Проекта.",
  "Техническа Комплексна Проверка (Technical Due Diligence) и Независими Технически Експертизи."
]
},
 {
title: "Прединвестиционни Проучвания и Подготовка на Тръжни Процедури",
intro: "Значимите инвестиционни решения следва да бъдат подкрепени от ясна техническа, икономическа и нормативна обосновка преди ангажирането на съществени финансови и организационни ресурси. Чрез прединвестиционни проучвания, анализи и дейности по планиране подпомагаме оценката на осъществимостта на проектите, намаляването на инвестиционния риск и създаването на стабилна основа за успешната им реализация.",
services: [
"Прединвестиционни Проучвания и Проучвания за Осъществимост.",
"Технико-Икономически Оценки.",
"Инвестиционна Оценка и Анализ „Разходи–Ползи“ (Cost-Benefit Analysis).",
"Оценка на Капиталовите и Експлоатационните Разходи (CAPEX/OPEX) и Анализ на Дисконтираните Парични Потoци (DCF).",
"Определяне на Проектните Изисквания и Разработване на Основите за Проектиране (Basis of Design – BoD).",
"Анализ на Технически и Проектни Варианти и Оценка на Алтернативни Решения.",
"Идейно, Предварително и Техническо Проектиране.",
"Изготвяне на Количествени Сметки (BoQ) и Оценка на Разходите (Клас A/B/C).",
"Анализ на Разходите за Жизнения Цикъл (LCCA).",
"Планиране на Доставките и Анализ на Пазара.",
"Изготвяне на Технически Спецификации и Тръжна Документация.",
"Техническа и Търговска Оценка на Оферти.",
"Оценка на Тръжни Предложения и Препоръки за Възлагане на Договор.",
"Консултации по Обществени Поръчки и Съдействие при Участие в Тръжни Процедури."
]
}
];
...
"Multi-Stage Design Set (Project Initiation, Conceptual, Preliminary, Technical and Detailed Designs).",
...
services: [
"Design of Transport Infrastructure (Road, Bridge, Tunnel Structural and Geometric Design).",
"Road Alignment and Geometric Design.",
"Pavement Engineering & Design.",
"Design of Railway Infrastructure and Associated Facilities.",
...
"Design of Urban and Interurban Transport Infrastructure.",
...
"Bridge Inspection, Technical and Structural Condition Assessment, and Load Capacity Assessment",
"Transport Infrastructure Condition Assessment.",
"Design of Rehabilitation, Strengthening and Modernisation (Structural and Functional Upgrading).",
...
services: [
  "Project Scope Definition and Initial Feasibility Assessment.",
  "Project Risk Identification and Initial Risk Assessment.",
  "Stakeholder Identification and Stakeholder Analysis.",
  "Project Management Plan (PMP) and Project Execution Plan (PEP).",
  "Work Breakdown Structure (WBS), Schedule Development and Critical Path Analysis.",
  "Cost Estimation, Budget Development and Cost Planning.",
  "Risk Management, Quality Management, Communication and Reporting Plans.",
  "Project Coordination and Multidisciplinary Design Management.",
  "Design Review and Technical Coordination.",
  "Quality Assurance (QA) and Quality Control (QC).",
  "Stakeholder and Authority Coordination.",
  "Project Controls (Schedule, Cost, Change, Document Control, KPI Reporting and Earned Value Management (EVM)).",
  ...
  "Technical Due Diligence and Independent Technical Reviews."
]
},
{
...
services: [
"Feasibility Studies and Pre-Investment Assessments.",
"Technical and Economic Assessment Studies.", 
"Investment Appraisal and Cost-Benefit Analysis.",
"CAPEX/OPEX Estimation and Discounted Cash Flow (DCF) Analysis.",
"Project Requirements Definition and Basis of Design (BoD).",
"Technical and Design Option Analysis and Evaluation of Alternative Solutions.", 
"Conceptual, Preliminary and Detailed Engineering Design.", 
"Bill of Quantities (BoQ) Preparation and Cost Estimation (Class A/B/C Estimates).",
"Life-Cycle Cost Analysis (LCCA).",
"Procurement Planning and Market Assessment.",
"Preparation of Technical Specifications and Tender Documentation.",
"Technical Bid and Commercial Bid Evaluation.",
...
}, 
{
  ...
  "Geotechnische Konformitätsprüfung nach Eurocode 7 und Nationalem Anhang"
]
}, 
{
  ...
  "Straßenoberbauplanung und Dimensionierung von Fahrbahnbefestigungen.",
  "Planung von Eisenbahninfrastrukturen und Verkehrsanlagen.",
  "Verkehrstechnische Untersuchungen, Verkehrsmanagement und Verkehrssicherheitsanalysen.",
  "Verkehrsplanung, Verkehrsprognosen und Verkehrsmodellierung.",
  "Planung städtischer und überörtlicher Verkehrsinfrastrukturen.",
  "Entwässerungsplanung sowie Böschungs- und Hangsicherungen.",
  "Straßensicherheitsaudits, Verkehrssicherheitsinspektionen und Sicherheitsbewertungen.",
  "Brückenprüfungen, Bauwerksprüfungen, Zustandsbewertungen sowie Tragfähigkeitsnachweise.",
  "Zustandsbewertung und Erhaltungsplanung von Verkehrsinfrastrukturen.",
  "Planung von Ausbau, Umbau, Sanierung und Ertüchtigung von Verkehrsinfrastrukturen.",
  "Genehmigungs- und Bewilligungsverfahren für Verkehrsinfrastrukturprojekte.",
  "Ingenieurtechnische Begleitung während der Bauausführung sowie Bauüberwachung."
]
},
{
  ...
  services: [
  "Geodätische Vermessungen (GNSS-, Tachymeter- und photogrammetrische Vermessungen).",
  "Topografische Vermessungen und geodätische Kartierung.",
  "Katastervermessungen sowie Erstellung von Katasterunterlagen, Lageplänen und vermessungstechnischen Dokumentationen.",
  "Digitale Gelände- und Oberflächenmodelle (DGM/DOM) sowie 3D-Modellierung von Gelände, Bauwerken und Anlagen mittels GNSS, LiDAR und UAV.",
  "Massenermittlungen und Erdbauvolumenberechnungen (Abtrag- und Auffüllmengen).",
  "Bauabsteckung sowie geodätische Kontrolle von Bauwerken, Ingenieurbauwerken und Grundstücksgrenzen.",
  "Präzisionsnivellements und Höhenplanung.",
  "Vermessungstechnische Kontrolle und geometrische Überwachung während der Bauausführung.",
  "Deformationsmessungen und Bewegungsanalysen von Bauwerken und Ingenieurbauwerken.",
  "Bestandsvermessung und Bestandsdokumentation für Abnahmen und Genehmigungs- bzw. Bewilligungsverfahren.",
  "Ortung, Vermessung und Dokumentation unterirdischer Ver- und Entsorgungsleitungen (Leitungskataster).",
  "Lagepläne, Bestandspläne und vermessungstechnische Planunterlagen.",
  "GIS-Analysen, Entwicklung von Geodatenbanken und Bestandsmanagement.",
  "BIM-Bestandsmodelle und Geodaten für Digital-Twin-Anwendungen.",
  "Vermessungstechnische Unterstützung bei Genehmigungs- und Bewilligungsverfahren."
]
},
{
  ...
  services: [ 
  "Projektdefinition, Leistungsabgrenzung und erste Machbarkeitsbewertung.", 
  "Identifikation von Projektrisiken und erste Risikobewertung.", 
  "Identifikation und Analyse der Projektbeteiligten.",
  "Projektmanagementplan (PMP) und Projektabwicklungsplan (PAP).", 
  "Projektstrukturplan (PSP), Terminplanung und Kritische-Pfad-Analyse.", 
  "Kostenschätzung, Budgetierung und Kostenplanung.", 
  "Pläne für Risiko-, Qualitäts-, Kommunikations- und Berichtswesen.", 
  "Projektkoordination und multidisziplinäres Planungsmanagement.", 
  "Planungsprüfung und technische Koordination.", 
  "Qualitätssicherung (QA) und Qualitätskontrolle (QC).", 
  "Koordination von Projektbeteiligten und Behörden.", 
  "Projektcontrolling (Termine, Kosten, Änderungen, Dokumentenmanagement, Leistungskennzahlen (KPI) und Earned Value Management (EVM)).", 
  "Fortschrittsüberwachung und Leistungsberichterstattung.", 
  "Risikoüberwachung und Risikosteuerung.", 
  "Qualitätsaudits und Überwachung der Regelkonformität.", 
  "Prüfung, Inbetriebnahme und Projektübergabe.", 
  "Technische Due Diligence sowie unabhängige technische Prüfungen und Bewertungen." 
]
},
{
...
services: [
"Machbarkeitsstudien und Vorinvestitionsanalysen.",
"Technische und wirtschaftliche Bewertungen.",
"Investitionsbewertung und Kosten-Nutzen-Analyse.",
"CAPEX-/OPEX-Schätzung und Discounted-Cash-Flow-Analyse (DCF).",
"Definition der Projektanforderungen und Erstellung der Planungsgrundlagen (Basis of Design – BoD).",
"Technische und planerische Variantenuntersuchungen sowie Bewertung von Alternativlösungen.",
"Konzept-, Vor- und Ausführungsplanung.",
"Erstellung von Leistungsverzeichnissen (LV) und Kostenschätzungen (Klasse A/B/C).",
"Lebenszykluskostenanalyse (Life-Cycle Cost Analysis – LCCA).",
"Beschaffungsplanung und Marktanalyse.",
"Erstellung technischer Spezifikationen und Ausschreibungsunterlagen.",
"Technische und kaufmännische Angebotsbewertung.",
"Auswertung von Ausschreibungen und Vergabeempfehlungen.",
"Beratung im öffentlichen Vergabewesen und Unterstützung bei Vergabeverfahren."
]
}
];

const bgProcessSteps = [
  { title: "Инициране", body: "Определяне целите на проекта, предварително проучване, оценяване техническата и финансовата осъществимост, определяне предварителния обхват, идентифициране на заинтересованите страни и разработване Устав на проекта. Анализиране на нормативните изисквания, ограниченията, допусканията, рисковете и бизнес целите, гарантиращи реалистична, законово съобразена и структурирана проектна рамка." },
  { title: "Планиране и Проектиране", body: "Разработване на обхвата, Work Breakdown Structure (WBS), графици, бюджети, идейни, технически и работни проекти, както и тръжна документация. Ресурсно планиране, разработване на планове за управление на промени, качество, комуникации, доставки и рискове. Създаване на референтна рамка за управление на обхвата, сроковете, ресурсите и разходите, гарантираща успешно изпълнение на проекта." },
...
const enProcessSteps = [
  ...
  { title: "Monitoring & Control", body: "Monitoring project performance against established baselines, execution control, progress tracking, risk management, and control of costs, schedules, quality, and changes through an integrated management approach, enabling early identification of deviations and timely corrective actions." },
  { title: "Closure", body: "Formal closure of project activities, acceptance of completed works, contractual and administrative closeout, resource release, archiving of project documentation, commissioning, and follow-up support. Documentation of lessons learned and effective project handover and finalization." },
];
...
const deProcessSteps = [
  ...
  { title: "Planung & Projektierung", body: "Entwicklung des Projektumfangs, der Work Breakdown Structure (WBS), Terminpläne, Budgets sowie konzeptioneller, technischer und Ausführungsplanungen einschließlich Ausschreibungsunterlagen. Ressourcenplanung sowie Erstellung von Plänen für Änderungs-, Qualitäts-, Kommunikations-, Beschaffungs- und Risikomanagement. Etablierung von Baselines für Leistungsumfang, Termine, Ressourcen und Kosten zur Sicherstellung einer erfolgreichen Projektausführung." },
  ...
  { title: "Monitoring & Kontrolle", body: "Überwachung der Projektleistung anhand definierter Baselines, Steuerung der Projektausführung, Fortschrittskontrolle, Risikomanagement sowie Kontrolle von Kosten, Terminen, Qualität und Änderungen durch einen integrierten Managementansatz, der eine frühzeitige Identifikation von Abweichungen und die rechtzeitige Einleitung von Korrekturmaßnahmen ermöglicht." },
...
const translations = {
  bg: {
    nav: { home: "Начало", about: "За нас", solutions: "УСЛУГИ", projects: "Проекти", contacts: "Контакти" },
  ...
  en: {
    nav: { home: "Home", about: "About", solutions: "SERVICES", projects: "Projects", contacts: "Contacts" },
    ...
    aboutHighlight: "Leveraging the high level of specialization within our partner network, UPSTRUX combines engineering expertise, integrated management throughout project planinng & execution, and access to specialized technical networks to support the entire development and construction lifecycle.",
  ...
  de: {
    nav: { home: "Start", about: "Über Uns", solutions: "LEISTUNGEN", projects: "Projekte", contacts: "Kontakt" },
...
function ServiceDetailPage({ service, t, setCurrentPage, mobileMenuOpen, setMobileMenuOpen, language, setLanguage, navItems }) {
  ...
  />
         ...
         <nav className={`${mobileMenuOpen ? "flex" : "hidden"} absolute left-1/2 top-full mt-1 -translate-x-1/2 w-auto flex-col items-start gap-3 rounded-xl bg-white px-6 py-4 text-left text-sm font-medium uppercase tracking-[0.14em] text-slate-900 shadow-lg md:static md:left-auto md:top-auto md:mt-0 md:flex md:w-auto md:max-w-none md:translate-x-0 md:flex-row md:items-end md:gap-12 md:rounded-none md:border-0 md:bg-transparent md:p-0 md:translate-y-10 md:text-slate-900 md:shadow-none`}>
    ...
    {item}
      ...
      {activeGalleryItem && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-950/80 px-6 py-10 backdrop-blur-sm">
          <div className="mx-auto flex max-h-[92vh] max-w-[110rem] flex-col bg-white lg:grid lg:grid-cols-[0.30fr_0.70fr]">
            ...
            <div className="relative min-h-[380px] bg-slate-100 lg:min-h-[700px]">
              <button
                type="button"
        ...
        <div className="justify-self-start text-left">
          ...
          <div className="space-y-2.5 text-[13px] text-slate-700">
            <div className="flex items-center gap-2.5">
              <PinIcon size={20} className="shrink-0 text-blue-600" />
              <span>{t.footer.location}</span>
            </div>

            <div className="hidden flex items-center gap-2.5">
              <PhoneIcon size={20} className="shrink-0 text-blue-600" />
              <span>+359 888 000 000</span>
            </div>

            <div className="flex items-center gap-2.5">
              <MailIcon size={20} className="shrink-0 text-blue-600" />
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-20 space-y-20">
            ...
            <ZigZagService
              key={service.title}
              title={service.title}
              text={service.intro || service.text}
              image={service.image}
        ...
        return (
          ...
          >
            ...
            <div className="px-6 py-6">
              ...
              >
                {isExpanded ? t.teamShowLess : t.teamShowMore}
              </button>
            </div>
          </article>
        );
