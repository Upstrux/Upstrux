...
const translations = {
  ...
  de: {
    ...
    engineeringCycle: "UPSTRUX koordiniert und steuert komplexe Engineering- und Investitionsprojekte, die eine enge Zusammenarbeit verschiedener technischer Fachdisziplinen, spezialisierter Expertenteams sowie weiterer Projektbeteiligter über den gesamten Investitions- und Bauprozess hinweg erfordern. Unser Ansatz geht über die Entwicklung einzelner Planungslösungen hinaus und basiert auf der effektiven Integration von Architekten, Tragwerksplanern, Geotechnikingenieuren, Wasserbauingenieuren, Verkehrsingenieuren, Vermessungsingenieuren und technischen Beratern innerhalb einer einheitlichen Projektumgebung. Durch einen integrierten Ansatz und die Koordination sämtlicher Projektphasen — von der Konzeptentwicklung bis zur Projektrealisierung — bietet UPSTRUX nachhaltige Ingenieurlösungen sowie die Optimierung des Projektumfangs, der finanziellen, technischen und personellen Ressourcen, der Terminparameter, des Qualitätsmanagements und des Projektrisikomanagements.",
