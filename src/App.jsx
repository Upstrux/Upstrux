...
const bgProcessSteps = [
  ...
  { title: "Планиране", body: "Разработване на обхвата, Work Breakdown Structure (WBS), графици, бюджети, идейни, технически и работни проекти, както и тръжна документация. Ресурсно планиране, разработване на планове за управление на промени, качество, комуникации, доставки и рискове. Създаване на референтна рамка за управление на обхвата, сроковете, ресурсите и разходите, гарантираща успешно изпълнение на проекта." },
...
const translations = {
  bg: {
    ...
    methodologyTitle: "Управление на Проекти",
  ...
  en: {
    ...
    methodologyTitle: "Project Management",
  ...
  de: {
    ...
    methodologyTitle: "Projektmanagement",
