...
const translations = {
  bg: {
    ...
    aboutHighlight: "Благодарение на високото ниво на специализация на нашите партньори, UPSTRUX обединява инженерна експертиза, цялостно управление при изпълнение, както и достъп до специализирани технически мрежи в подкрепа на целия инвестиционен и строителен процес.",
  ...
  en: {
    ...
    aboutHighlight: "Leveraging the high level of specialization within our partner network, UPSTRUX combines engineering expertise, integrated management throughout project execution, as well as access to specialized technical networks to support the entire development and construction lifecycle.",
