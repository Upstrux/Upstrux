...
const translations = {
  bg: {
    ...
    aboutHighlight: "Благодарение на високото ниво на специализация на нашите партньори, UPSTRUX обединява инженерна експертиза, цялостно управление при изпълнение и реализация, както и достъп до специализирани технически мрежи в подкрепа на целия инвестиционен и строителен процес.",
  ...
  en: {
    ...
    aboutHighlight: "Leveraging the high level of specialization within our partner network, UPSTRUX combines engineering expertise, integrated management in project execution and delivery, access to specialized technical networks to support the entire development and construction lifecycle.",
  ...
  de: {
    ...
    aboutHighlight: "Dank des hohen Spezialisierungsgrades unseres Partnernetzwerks vereint UPSTRUX ingenieurtechnische Expertise, Integriertes Management bei der Projektdurchführung und -abwicklung sowie den Zugang zu spezialisierten technischen Netzwerken zur Unterstützung des gesamten Entwicklungs- und Bauprozesses.",
