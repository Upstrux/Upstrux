...
const translations = {
  bg: {
    ...
    aboutHighlight: "Благодарение на високото ниво на специализация на нашите партньори, UPSTRUX обединява инженерна експертиза, координация на проектната реализация и достъп до специализирани технически мрежи в подкрепа на целия инвестиционен и строителен процес.",
  ...
  en: {
    ...
    aboutTitle: "About us",
    aboutP1: "UPSTRUX brings together civil, structural and site engineers, and project management with expertise in coordinating complex projects requiring effective collaboration between multiple technical disciplines, specialized expert teams, and stakeholders throughout the entire project lifecycle — from initiation and planning through execution, monitoring and control, and project close-out.",
    ...
    aboutHighlight: "Leveraging the high level of specialization within our partner network, UPSTRUX combines engineering expertise, project delivery coordination, and access to specialized technical networks to support the entire development and construction lifecycle.",
  ...
  de: {
    ...
    aboutHighlight: "Dank des hohen Spezialisierungsgrades unseres Partnernetzwerks vereint UPSTRUX ingenieurtechnische Expertise, Koordination der Projektabwicklung sowie den Zugang zu spezialisierten technischen Netzwerken zur Unterstützung des gesamten Entwicklungs- und Bauprozesses.",
