...
const ZigZagService = memo(function ZigZagService({ title, text, image, reverse, servicePage, setCurrentPage, learnMoreLabel }) {
  ...
  return (
    <motion.div
      ...
      className="group scroll-mt-28 grid cursor-pointer items-center gap-12 rounded-none border border-transparent bg-transparent p-4 transition-all duration-700 ease-out hover:-translate-y-1 hover:border-slate-200 focus:outline-none focus-visible:border-blue-300 sm:p-5 lg:grid-cols-2 lg:gap-16 lg:p-6"
    >
