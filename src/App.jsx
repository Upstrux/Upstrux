...
const translations = {
  bg: {
    ...
    aboutTitle: "За Нас",
    aboutP1: "UPSTRUX предоставя услуги в областта на интегрираното инженерство и цялостното разработване и реализиране на проекти, обединяващ инженерна експертиза, специализирани технически мрежи и мултидисциплинарни екипи в подкрепа на комплексни проекти през целия им жизнен цикъл в Европа и Близкия изток.",
  ...
  de: {
    ...
    engineeringCycle: "UPSTRUX koordiniert und steuert komplexe Ingenieur- und Investitionsprojekte, die eine enge Zusammenarbeit verschiedener technischer Fachdisziplinen, spezialisierter Expertenteams und relevanter Stakeholder entlang des gesamten Investitions- und Bauprozesses erfordern. Unser Ansatz geht über die Entwicklung einzelner Planungslösungen hinaus und basiert auf der effektiven Integration von Architekten, Ingenieuren, Fachplanern, Beratern und Projektmanagern in einer gemeinsamen Projektumgebung. Durch unseren integrierten Ansatz in Engineering und Projektmanagement, fundierte technische Expertise sowie die durchgängige Steuerung und Überwachung aller Phasen der Projektabwicklung – von der Konzeptentwicklung bis zur Projektrealisierung – bietet UPSTRUX nachhaltige Ingenieurlösungen und ein ganzheitliches Lifecycle-Management, wodurch wir langfristigen Mehrwert für unsere Kunden schaffen.",
