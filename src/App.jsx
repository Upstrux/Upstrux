...
const bgServices = [
  ...
  { title: "Организация и управление на строителството", text: "Инвестиционно планиране, подготовка и реализация на строителни и инвестиционни проекти; Управление на строителството, техническо ръководство; Инвеститорски контрол, технически контрол, количествено-стойностни сметки и договорно администриране; Въвеждане в експлоатация, координация между участници в строителния процес и управление на строителни активи" },
...
const enServices = [
  { title: "Structural design of buildings and facilities", text: "Design of buildings, facilities and engineering infrastructure; Concept, technical and detailed design documentation; Structural calculations, static and dynamic analyses, seismic engineering; Geological, geotechnical, hydrogeological, drilling and retaining structure investigations; Inspection and testing of building structures; Seismic assessment, restoration and strengthening of structures; BIM modelling, coordination and integrated engineering solutions" },
  ...
  { title: "Construction organization and management", text: "Investment planning, preparation and delivery of construction and investment projects; Construction management and technical supervision; Investor control, technical control, bills of quantities and contract administration; Commissioning, coordination between project participants and management of construction assets" },
...
const deServices = [
  ...
  { title: "Organisation und Management des Bauprozesses", text: "Investitionsplanung, Vorbereitung und Umsetzung von Bau- und Investitionsprojekten; Bauleitung und technische Leitung; Bauherrenvertretung, technische Kontrolle, Leistungsverzeichnisse und Vertragsadministration; Inbetriebnahme, Koordination aller Projektbeteiligten und Management von Bauanlagen" },
...
const bgProcessSteps = [
  { title: "Иницииране", body: "Всеки успешен проект започва със стабилна основа. Дефинираме целите на проекта, оценяваме техническата и финансовата осъществимост, определяме предварителния обхват, идентифицираме заинтересованите страни и разработваме Project Charter (Устав на проекта). Анализираме нормативните изисквания, ограниченията, допусканията, рисковете и бизнес целите, за да гарантираме реалистична, законово съобразена и правилно структурирана проектна рамка.", focus: "Основен фокус: Стратегически цели, заинтересовани страни, осъществимост, законова рамка и официално стартиране." },
  { title: "Планиране", body: "Планирането трансформира проектните цели в детайлна управленска система. Определяне на обхвата, Work Breakdown Structure (WBS), графици, бюджети, управление на качеството, ресурси, комуникации, доставки и рискове. Чрез интегриране на технически, оперативни и регулаторни елементи създаваме ясни базови линии за обхват, време и разходи, гарантирайки проектна готовност за успешно изпълнение.", focus: "Основен фокус: Обхват, график, бюджет, качество, ресурси, риск, доставки и заинтересовани страни." },
  { title: "Изпълнение", body: "Проектът преминава в активна реализация чрез координация на инженерни дейности, проектантски решения, СМР, доставки, управление на екипи и контрол на качеството. Фокусът е върху ефективното изпълнение, техническическото ръководство, управлението на изпълнители, ефективната комуникация и непрекъснатата оптимизация на производителността.", focus: "Основен фокус: Изпълнение, координация, качество, заинтересовани страни и контрол върху реализацията." },
  { title: "Мониторинг и контрол", body: "Осъществяваме постоянен мониторинг на проекта спрямо установените базови линии, следим напредъка, управляваме рисковете, контролираме разходите, качеството и промените чрез интегриран контрол. Това позволява ранно откриване на отклонения, навременни коригиращи действия.", focus: "Основен фокус: Проследяване на изпълнението, управление на промени, риск, качество, прогнози и съответствие." },
  { title: "Закриване", body: "Финалният етап гарантира официално приключване на всички проектни дейности, приемане на изпълнените работи, приключване на договорите, освобождаване на ресурси и архивиране на документацията. Документираме извлечените поуки и осигуряваме надеждно предаване на проекта.", focus: "Основен фокус: Официално приемане, финансово приключване, документация, знания и предаване." },
];

const enProcessSteps = [
  { title: "Initiation", body: "Every successful project starts with a solid foundation. We define the project objectives, assess technical and financial feasibility, determine the preliminary scope, identify stakeholders and develop the Project Charter. We analyze regulatory requirements, constraints, assumptions, risks and business goals to ensure a realistic and legally compliant project framework.", focus: "Main focus: Strategic objectives, stakeholders, feasibility, legal framework and formal project launch." },
  { title: "Planning", body: "Planning transforms project objectives into a detailed management system. We define scope, WBS, schedules, budgets, quality, resources, communications, procurement and risks. By integrating technical, operational and regulatory elements, we establish clear baselines for scope, time and cost.", focus: "Main focus: Scope, schedule, budget, quality, resources, risk, procurement and stakeholders." },
  { title: "Execution", body: "The project moves into active delivery through coordination of engineering activities, design solutions, construction works, procurement, team management and quality control. The focus is efficient execution, technical management, contractor coordination, effective communication and continuous performance optimization.", focus: "Main focus: Execution, coordination, quality, stakeholders and delivery control." },
  { title: "Monitoring and control", body: "We continuously monitor the project against established baselines, track progress, manage risks, control cost, quality and changes through integrated control. This enables early detection of deviations and timely corrective actions.", focus: "Main focus: Performance tracking, change management, risk, quality, forecasting and compliance." },
  { title: "Closing", body: "The final stage ensures formal completion of all project activities, acceptance of completed works, contract closure, release of resources and archiving of documentation. We document lessons learned and ensure reliable project handover.", focus: "Main focus: Formal acceptance, financial closure, documentation, knowledge and handover." },
];

const deProcessSteps = [
  { title: "Initiierung", body: "Jedes erfolgreiche Projekt beginnt mit einer soliden Grundlage. Wir definieren Projektziele, bewerten technische und wirtschaftliche Machbarkeit, bestimmen den vorläufigen Umfang, identifizieren Stakeholder und entwickeln die Projektcharta.", focus: "Fokus: Strategische Ziele, Stakeholder, Machbarkeit, rechtlicher Rahmen und offizieller Projektstart." },
  { title: "Planung", body: "Die Planung überführt Projektziele in ein detailliertes Managementsystem. Wir definieren Umfang, WBS, Termine, Budgets, Qualität, Ressourcen, Kommunikation, Beschaffung und Risiken.", focus: "Fokus: Umfang, Zeitplan, Budget, Qualität, Ressourcen, Risiken, Beschaffung und Stakeholder." },
  { title: "Ausführung", body: "Das Projekt geht in die aktive Umsetzung über: Koordination von Ingenieurleistungen, Planungslösungen, Bauarbeiten, Lieferungen, Teams und Qualitätskontrolle.", focus: "Fokus: Ausführung, Koordination, Qualität, Stakeholder und Kontrolle der Umsetzung." },
  { title: "Monitoring und Kontrolle", body: "Wir überwachen das Projekt kontinuierlich anhand definierter Baselines, verfolgen den Fortschritt, steuern Risiken und kontrollieren Kosten, Qualität und Änderungen.", focus: "Fokus: Fortschrittskontrolle, Änderungsmanagement, Risiken, Qualität, Prognosen und Compliance." },
  { title: "Abschluss", body: "Die Abschlussphase gewährleistet die formale Beendigung aller Projektaktivitäten, Abnahme der Leistungen, Vertragsabschluss, Ressourcenfreigabe und Archivierung der Dokumentation.", focus: "Fokus: Formale Abnahme, finanzieller Abschluss, Dokumentation, Wissenstransfer und Übergabe." },
];
...
function ZigZagService({ title, text, image, reverse }) {
...
function ProcessStep({ step, index }) {
  ...
  const sizeClass = index === 0 ? "w-full max-w-[620px] min-h-[260px] p-5 sm:min-h-[230px] lg:aspect-[1.618/0.68] lg:min-h-0" : index === 1 ? "w-full max-w-[620px] min-h-[240px] p-4 sm:min-h-[210px] lg:aspect-[1.618/0.6] lg:min-h-0" : "w-full max-w-[620px] min-h-[220px] p-4 sm:min-h-[190px] lg:aspect-[1.618/0.52] lg:min-h-0";
  return (
    <div className={`relative flex ${isRight ? "justify-end" : "justify-start"}`}>
      ...
      <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: index * 0.05 }} className={`${sizeClass} relative z-10 flex flex-col justify-between overflow-hidden rounded-[1.5rem] bg-gradient-to-br from-blue-600 via-indigo-700 to-red-500 transition duration-300 hover:-translate-y-1`}>
        <div className={`flex flex-1 flex-col justify-between text-white/90 ${isCompact ? "mt-1 gap-2" : "mt-2 gap-3"}`}>
...
function LegalContentPage({ page, onBack, backLabel }) {
  return (
    <div className="min-h-screen bg-white text-slate-950">
      ...
      <div className="mx-auto mt-2 mb-2 flex max-w-7xl items-center justify-center px-6"><div className="h-[0.5px] w-full max-w-[48rem] bg-gradient-to-r from-blue-500 via-indigo-500 to-red-500" /></div>
...
export default function UpstruxWebsite() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-950">
      <header className="absolute left-0 right-0 top-0 z-50 pt-7 text-white"><div className="mx-auto flex max-w-7xl items-start justify-between px-6"><a href="#home" aria-label="UPSTRUX home"><Logo /></a><nav className="hidden items-center gap-12 pt-3 text-sm font-light uppercase tracking-[0.18em] md:flex">{navItems.map((item) => item.key === "solutions" ? <div key={item.key} className="relative" onMouseEnter={() => setServicesOpen(true)} onMouseLeave={() => setServicesOpen(false)}><button className="flex items-center gap-2 transition-colors hover:text-blue-300">{item.label}<span className={`transition-transform duration-200 ${servicesOpen ? "rotate-180" : ""}`}>▼</span></button>{servicesOpen && <div className="absolute left-1/2 top-full mt-3 aspect-[1.68/1] w-[420px] -translate-x-1/2 border border-white/10 bg-slate-950/[0.168] p-5 shadow-2xl backdrop-blur-md"><div className="flex h-full flex-col justify-between text-[15px] normal-case tracking-normal text-white">{currentServices.map((service) => <a key={service.title} href={`#service-${slugify(service.title)}`} className="block rounded-lg px-2 py-1.5 font-light leading-5 text-slate-100 transition hover:bg-white/10 hover:text-blue-300">{service.title}</a>)}</div></div>}</div> : <a key={item.key} href={item.href} className="transition-colors hover:text-blue-300">{item.label}</a>)}<div className="flex items-center gap-2 text-xs font-light tracking-[0.12em]">{["bg", "en", "de"].map((lang) => <button key={lang} type="button" onClick={() => setLanguage(lang)} className={`cursor-pointer uppercase transition hover:text-blue-300 ${language === lang ? "text-blue-300" : "text-white"}`}>{lang}</button>)}</div></nav></div></header>
      <main>
