...
export default function UpstruxWebsite() {
  ...
  const setCurrentPage = useCallback((page) => {
    const nextPage = SERVICE_PAGE_KEYS.includes(page) ? "solutions" : page;
  ...
  useEffect(() => {
    ...
    if (routeInfo.page === "solutions" && normalizePath(window.location.pathname) !== getLocalizedPath("solutions", routeInfo.language)) {
      window.history.replaceState(
        { page: "solutions", language: routeInfo.language },
        "",
        getLocalizedPath("solutions", routeInfo.language)
      );
