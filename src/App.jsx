...
const enServices = [
  {title: "Asset Assessments, Diagnostics & Structural Verification", text: "Existing structures often face increasing performance demands, aging materials, changing regulations, and evolving operational requirements. Whether the objective is asset rehabilitation, change of use, regulatory compliance, investment due diligence, or long-term asset management, reliable engineering evidence is essential for informed decision-making. Our structural assessment, testing, and verification services provide an independent evaluation of structural condition, safety, performance, and remaining service life. Through inspections, load testing, advanced analysis, material investigations, and code-based verification, we help owners, investors, operators, and public authorities understand structural risks, prioritize interventions, support investment decisions, and maintain confidence in the safety and reliability of their assets."},
