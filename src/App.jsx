...
const bgServices = [
  ...
  { title: "Хидротехническо и хидромелиоративно проектиране ", text: "Проектиране на хидротехнически съоръжения и обекти със стратегическо значение — ВЕЦ, ПАВЕЦ; Проектиране на язовири, водохващания, деривации, тунели и съоръжения и прилежаща инфраструктура към ВЕЦ и ПАВЕЦ; Проектиране и обследване на хидромелиоративни системи — напоителни и отводнителни мрежи; Проектиране на съоръжения за управление, регулиране и защита на водните ресурси; Оценка на техническото състояние, експлоатационната надеждност и безопасността на хидротехнически съоръжения; Обследване и анализ на хидротехнически съоръжения при аварийни и експлоатационни състояния; Хидравлични и инженерни анализи на водопроводящи системи и съоръжения; Проектиране на диги, укрепителни съоръжения и системи за защита от наводнения и ерозионни процеси; Консултиране при прилагане на нормативни изисквания, технически стандарти и инженерни решения в областта на хидротехническото строителство; Изготвяне на технически експертизи, становища и инвестиционни проекти за хидротехническа инфраструктура."},
...
const enServices = [
  ...
  {title: "Hydrotechnical and Hydraulic Engineering Design", text: "Design of hydrotechnical facilities and strategically significant infrastructure including HPP and PSHPP projects; Design of dams, water intakes, diversions, tunnels and associated infrastructure for hydropower facilities; Design and assessment of irrigation and drainage systems; Design of facilities for water resource management, regulation and protection; Assessment of the technical condition, operational reliability and safety of hydrotechnical structures; Investigation and analysis of hydrotechnical facilities under operational and emergency conditions; Hydraulic and engineering analyses of water conveyance systems and facilities; Design of embankments, retaining structures and flood and erosion protection systems; Consulting on regulatory requirements, technical standards and engineering solutions in hydrotechnical construction; Preparation of technical assessments, expert reports and investment design projects for water infrastructure."},
...
const deServices = [
  ...
  {title: "Wasserbau- und Hydraulikplanung",  text: "Planung wasserbaulicher Anlagen und strategischer Infrastrukturprojekte einschließlich Wasserkraftwerken und Pumpspeicherkraftwerken; Planung von Talsperren, Wasserfassungen, Ableitungssystemen, Tunneln und zugehöriger Infrastruktur; Planung und Bewertung von Bewässerungs- und Entwässerungssystemen; Planung von Anlagen zur Wasserbewirtschaftung, Regulierung und zum Hochwasserschutz; Bewertung des technischen Zustands, der Betriebssicherheit und Zuverlässigkeit wasserbaulicher Bauwerke; Untersuchung und Analyse wasserbaulicher Anlagen unter Betriebs- und Störfallbedingungen; Hydraulische und ingenieurtechnische Analysen von Wassertransportsystemen und Anlagen; Planung von Dämmen, Stützbauwerken sowie Hochwasser- und Erosionsschutzsystemen; Beratung zu regulatorischen Anforderungen, technischen Normen und ingenieurtechnischen Lösungen im Wasserbau; Erstellung technischer Gutachten, Sachverständigenberichte und Investitionsplanungen für wasserbauliche Infrastruktur."},
...
{servicePage === "service6" && (
  ...
  <div className="overflow-hidden bg-white">
    <img
      src={image}
      alt={title}
     className="aspect-[1.68/1] w-full object-cover min-h-[340px] sm:min-h-[420px] lg:min-h-[500px]"
    />
  </div>
);
  return (
